...
import 'package:uidesign/SampleApps/app_clone/sports_store/sports_store_detail_page.dart';
...
const balls = [
  const Ball(
      ...
      image: 'assets/images/balls/ball1.png'),
  const Ball(
      price: 30,
      name: 'UEFA CL 18',
      model: 'UEFA blue',
      ...
      textColor: Colors.white,
      image: 'assets/images/balls/ball2.png'),
  const Ball(
      price: 31,
      name: 'Nike Strike X',
      ...
      image: 'assets/images/balls/ball3.png'),
  const Ball(
      price: 40,
      ...
      textColor: Colors.white,
      image: 'assets/images/balls/ball4.png'),
];
        ...
        children: [
          ListTile(
            ...
            leading: CircleAvatar(
              ...
              backgroundImage: AssetImage('assets/images/mesi.png'),
            ),
            title: Text(
              'Lionel Messi',
              style: TextStyle(
