...
import 'package:uidesign/SampleApps/app_clone/shoes_store/shoes_store_detail_page.dart';
...
const shoesBottom = [
  const Shoe(name: 'NIKE AIR-MAX', price: 170.00, image: 'assets/images/shoes/3.png'),
  const Shoe(
      name: 'NIKE AIR FORCE', price: 130.00, image: 'assets/images/shoes/4.png'),
  const Shoe(
      name: 'NIKE AIR FORCE', price: 190.00, image: 'assets/images/shoes/4.png'),
  const Shoe(
      name: 'NIKE AIR FORCE', price: 120.00, image: 'assets/images/shoes/4.png'),
  const Shoe(
      name: 'NIKE AIR FORCE', price: 140.00, image: 'assets/images/shoes/4.png'),
  const Shoe(
      name: 'NIKE AIR FORCE', price: 150.00, image: 'assets/images/shoes/4.png'),
];
