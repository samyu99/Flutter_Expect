...
import 'package:uidesign/Styles/Animation/hero_animations/hero_dialog_route.dart';
import 'package:uidesign/Styles/Animation/hero_animations/page1.dart';
import 'package:uidesign/Styles/Animation/hero_animations/page2.dart';
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              _buildCustomButton("Hero on Dialog", _buildPopUp(context),
                  isPopup: true),
              _buildCustomButton("Custom Hero Styles.Animation", Page1(),
                  isCustom: true),
              Hero(
                tag: "hero1",
                child: ClipOval(
